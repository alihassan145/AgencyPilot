...
export default function AdminNotifications() {
  ...
  const { items, loading, exporting } = useSelector((s) => s.notifications);
  const { canCreateNotification, canEditNotification, canDeleteNotification, canExportNotifications } = usePermissions();
  ...
  const handleExport = () => {
    dispatch(exportNotifications()).then((result) => {
      if (result.payload) {
    ...
    <div className="p-8 space-y-6 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600">All alerts across the system</p>
        </div>
